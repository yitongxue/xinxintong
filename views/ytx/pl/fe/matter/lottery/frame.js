...
ngApp.config(['$controllerProvider', '$routeProvider', '$locationProvider', function($controllerProvider, $routeProvider, $locationProvider) {
	...
	$routeProvider.when('/rest/pl/fe/matter/lottery/award', {
		templateUrl: '/views/ytx/pl/fe/matter/lottery/award.html?_=1',
		controller: 'ctrlAward',
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/lottery/award.js', function() {
						defer.resolve();
					});
				})();
		...
		templateUrl: '/views/ytx/pl/fe/matter/lottery/plate.html?_=1',
		controller: 'ctrlPlate',
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/lottery/plate.js', function() {
						defer.resolve();
					});
				})();
				return defer.promise;
		...
		templateUrl: '/views/ytx/pl/fe/matter/lottery/page.html?_=1',
		controller: 'ctrlPage',
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/lottery/page.js', function() {
						defer.resolve();
					});
				})();
				return defer.promise;
		...
		templateUrl: '/views/ytx/pl/fe/matter/lottery/running.html?_=1',
		controller: 'ctrlRunning',
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/lottery/running.js', function() {
						defer.resolve();
					});
				})();
				return defer.promise;
		...
		templateUrl: '/views/ytx/pl/fe/matter/lottery/setting.html?_=1',
		controller: 'ctrlSetting',
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/lottery/setting.js', function() {
						defer.resolve();
					});
				})();
				return defer.promise;
