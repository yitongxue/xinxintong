	...
	$routeProvider.when('/rest/pl/fe/matter/group/player', {
		...
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/group/player.js', function() {
						defer.resolve();
					});
				})();
		...
		templateUrl: '/views/ytx/pl/fe/matter/group/running.html?_=2',
		controller: 'ctrlRunning',
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/group/running.js', function() {
						defer.resolve();
					});
				})();
				return defer.promise;
		...
		templateUrl: '/views/ytx/pl/fe/matter/group/setting.html?_=2',
		controller: 'ctrlSetting',
		resolve: {
			load: function($q) {
				var defer = $q.defer();
				(function() {
					$.getScript('/views/ytx/pl/fe/matter/group/setting.js', function() {
						defer.resolve();
					});
				})();
				return defer.promise;
