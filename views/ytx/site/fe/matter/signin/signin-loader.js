	...
	load: function() {
		require.config({
			paths: {
				...
				"enroll-directive": "/views/ytx/site/fe/matter/signin/directive",
				"enroll-common": "/views/ytx/site/fe/matter/signin/common",
			},
			shim: {
				"angular": {
					exports: "angular"
			...
			deps: ['/views/ytx/site/fe/matter/signin/signin.js'],
